...
export default class extends Controller {
  ...
  static targets = ["lengthnumber", "rangeinput", "textinput", "mayus", "numbers", "symbols", "divcarga", "textshow"]
  ...
  connect() {
    ...
    console.log(this.textshowTarget.classList.contains('texto-aparece-animation'));
